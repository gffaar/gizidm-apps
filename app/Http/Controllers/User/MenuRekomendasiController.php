...
class MenuRekomendasiController extends Controller
{
    ...
    public function index()
    {
        ...
        if($rekamGizi === null) {
            return redirect()->route('user.rekam-gizi.create')->with('error', 'Silahkan isi data rekam gizi terlebih dahulu.');
        }
        ...
        if ($search === null) {
            if ($menuRekomendasi->count() === 0) {
                return redirect()->route('user.menu-rekomendasi.otomatis-pilih', ['rekamGizi' => $rekamGizi->id]);
            }
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.menu-rekomendasi.index')->with('success', 'Menu rekomendasi berhasil ditambahkan');
    }
    ...
    public function destroy(MenuRekomendasi $menuRekomendasi)
    {
        ...
        return redirect()->route('user.menu-rekomendasi.index')->with('success', 'Menu rekomendasi berhasil dihapus');
    }

    public function otomatisPilih(Request $request, RekamGizi $rekamGizi)
    {
        ...
        try {
            ...
            return redirect()->route('user.menu-rekomendasi.index')->with('success', 'Rekomendasi menu berhasil dibuat');
